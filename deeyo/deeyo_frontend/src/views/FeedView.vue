    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        <div class="main-left col-span-1">
            <div class="p-4 bg-white border border-gray-200 text-center rounded-lg">
                <img src="https://i.pravatar.cc/300?img=53" class="mb-6 rounded-full">
                <p><strong>Code With Dave</strong></p>
        ...
        <div class="main-center col-span-2 space-y-4" >
            <div class=" bg-white border border-gray-200 text-center rounded-lg">
                <div class="p-4">
                    <textarea class="p-8 w-full bg-gray-200 rounded-lg" placeholder="Write something here"></textarea>
                </div>
                <div class=" p-4 border-t border-gray-100 flex justify-between">
                    <a href="#" class=" inline-block py-4 px-6 bg-gray-600 text-white rounded-lg">Attach</a>
            ...
            <div class="p-4 bg-white border border-gray-200 text-center rounded-lg">
                <div class="mb-6 flex items-center justify-between">
                    <div class="flex items-center space-x-6">
                        <img src="https://i.pravatar.cc/70?img=53" class="w-[40px] rounded-full">
                        <p><strong>Code with Dave</strong></p>
                    </div>
        ...
        <div class="main-right col-span-1 space-y-4">
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                <h3 class="mb-4 text-xl">People you may know</h3>
                ...
                <div class="space-y-4"> 
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2">
                            <img src="https://i.pravatar.cc/70?img=53" class="w-[40px] rounded-full">
                            <p class="text-xs"><strong>Code with Dave</strong></p>
                        </div>
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                <h3 class="mb-4 text-xl">Trends</h3>
                ...
                <div class="space-y-4"> 
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-2">
                            <p class="text-xs">
                                <strong>#Code with Dave</strong><br>
